...
export const ingresoUsuarioAccion = () => async(dispatch) =>{
    ...
    try {
        ...
        //preguntamos si existe esta colecion
        ...
        //obtenemos el uid y email del usuario
...
export const editarFotoAccion = (imagenEditada) => async(dispatch, getState) => {
    ...
    try {
            //referencia al directorio de la imagen guardada 
        const imagenRef = storage.ref().child(user.email).child('foto perfil')
        await imagenRef.put(imagenEditada) //put para actualizar la imagen
